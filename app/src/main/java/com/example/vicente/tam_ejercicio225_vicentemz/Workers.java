    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setView(mView1).setTitle("NUEVO TRABAJADOR")
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (nombre.equals("") && actividad.equals("") && celular.equals("") ){
                            ...
                            dialog.dismiss();
                            Snackbar.make(view,"Guardado",Snackbar.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void fetchWorkersRecords() {
        try{
            ...
            if (data.size()>0){
                ...
                Toast.makeText(Workers.this, "No hay resultados.", Toast.LENGTH_SHORT).show();
            }
        }
        catch (Exception e){
