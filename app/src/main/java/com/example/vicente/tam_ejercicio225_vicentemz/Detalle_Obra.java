package com.example.vicente.tam_ejercicio225_vicentemz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterDetalle.setOnItemClickListener(new WorkerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final int position) {
                //SE INFLA EL EDIT
                Toast.makeText(Detalle_Obra.this, "Editor", Toast.LENGTH_SHORT).show();
                ...
                builder.setView(mView1).setTitle("Agregar trabajador")
                ...
                btnGuardar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (fechaIni.equals("") || fechFin.equals("") || cantidad.equals("") || pago.equals("")){
                            ...
                            Snackbar.make(view,"Editando",Snackbar.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
                btnEliminar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      dbFunctions.DeletDetail(idCliente,idTrabajador);
                        Snackbar.make(v,"Borrando",Snackbar.LENGTH_SHORT).show();
                        fetchDetailsRecords();
    ...
    public void fetchWorkersRecords() {
        try{
            ...
            if (data.size()>0){
                ...
                Toast.makeText(Detalle_Obra.this, "No hay resultados.", Toast.LENGTH_SHORT).show();
            }
        }
        catch (Exception e){
